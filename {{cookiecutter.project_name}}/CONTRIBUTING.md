...
Welcome to {{ cookiecutter.project_name }}! Before contributing to the project,
make sure that you **read our code of conduct** (`CODE_OF_CONDUCT.md`).

## Contributing code

1. Set up a Python development environment
   (advice: use [venv](https://docs.python.org/{{ cookiecutter.requires_python }}/library/venv.html),
...
7. Run the tests: `tox -e py{{ cookiecutter.requires_python.replace('.', '') }}`
